...
altquiz_button_img = tk.PhotoImage(file = resource_path('Images/altquizzes_button.png'))
...
altguides_button_img = tk.PhotoImage(file = resource_path('Images/altguides_button.png'))
